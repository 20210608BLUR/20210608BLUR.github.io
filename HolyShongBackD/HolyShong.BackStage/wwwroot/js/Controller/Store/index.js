let app = new Vue({
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: 'storeCategoryName', label: '餐廳類別', sortable: false, sortDirection: 'desc' },
                { key: 'storeName', label: '餐廳名稱', sortable: false, sortDirection: 'desc' },
                { key: 'productImg', label: '餐廳圖片' },
                { key: 'memberId', label: '餐廳負責人', sortable: false},
    ...
    methods: {
        ...
        StoreCreate() {
            window.location.href = '/Store/AddStore';
        },
        ProductModify(id) {
